...
mixin _$PaymentMethodsState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(
            (List<SavedPaymentMethodEntity>, List<PaymentGatewayEntity>) data)
        loaded,
    ...
    return _then(_$LoadedImpl(
      null == data
          ...
          : data // ignore: cast_nullable_to_non_nullable
              as (List<SavedPaymentMethodEntity>, List<PaymentGatewayEntity>),
    ));
  }
}
...
class _$LoadedImpl implements _Loaded {
  ...
  @override
  final (List<SavedPaymentMethodEntity>, List<PaymentGatewayEntity>) data;

  @override
  String toString() {
    return 'PaymentMethodsState.loaded(data: $data)';
  }
...
abstract class _Loaded implements PaymentMethodsState {
  ...
  (List<SavedPaymentMethodEntity>, List<PaymentGatewayEntity>) get data;
  @JsonKey(ignore: true)
  _$$LoadedImplCopyWith<_$LoadedImpl> get copyWith =>
      throw _privateConstructorUsedError;
}
